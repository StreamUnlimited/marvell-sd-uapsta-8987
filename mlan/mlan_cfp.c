...
#define RATEID_9_6_MASK                                                        \
	(((1 << (1 + RATEID_OFDM9Mbps - RATEID_OFDM6Mbps)) - 1)                \
	 << RATEID_OFDM6Mbps)

#define RATEID_12_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM12Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)

#define RATEID_18_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM18Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)

#define RATEID_24_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM24Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)

#define RATEID_36_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM36Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)

#define RATEID_48_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM48Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)

#define RATEID_54_6_MASK                                                       \
	(((1 << (1 + RATEID_OFDM54Mbps - RATEID_OFDM6Mbps)) - 1)               \
	 << RATEID_OFDM6Mbps)
enum {
	RATEID_DBPSK1Mbps,	//(0)
	RATEID_DQPSK2Mbps,	//(1)
...
#define ANTENNA_OFFSET 2
	if (MFALSE || IS_SD8987(priv->adapter->card_type)
		) {
